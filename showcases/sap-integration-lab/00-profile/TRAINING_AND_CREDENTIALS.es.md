# Formación y Credenciales SAP

[English version](./TRAINING_AND_CREDENTIALS.md)
...
### ABAP Cloud — Diccionario de datos

El material suministrado cubre tipos de datos Dictionary, tablas de base de datos, ajustes de persistencia, objetos de bloqueo, Dynamic Cache y relaciones entre tablas.

### abapGit · ATC · ABAP Cleaner · Autorizaciones

El material suministrado cubre flujo de repositorios con abapGit/GitHub, ATC / ABAP Test Cockpit, conceptos de ATC Cloud, perfiles/reglas de ABAP Cleaner y conceptos de autorizaciones ABAP incluyendo `AUTHORITY-CHECK`, objetos de autorización y campos.
