...
**Status: COMPLETE FOR THE CURRENT PUBLIC SAP EVIDENCE SET.**
...
- SAP training credentials: recruiter-facing credential metadata reconciled against the account owner's certificate files.
- Odoo credential: indexed separately from SAP.

## Excluded from the public repository

- raw course PDFs and Word submissions;
- certificate PDFs, QR codes and credential identifiers;
- instructor-branded screenshots and course pages;
...
Public evidence describes only what is already supported by source, completed training, documented historical execution, sanitized owned visuals, observed CI/local results, or sanitized enterprise experience. Capabilities outside that evidence are omitted or stated only as claim boundaries.
